...
dds_rds <- here("doc/diff_expression/rdata/dds_gz_cp.rds")
...
if(write_plots){ggsave(file.path(pdf_dir,"pca_gz_cp_batch_corrected.pdf"), width = 7, height = 6, useDingbats = FALSE)}
...
p1 <- ggplot(shrunkres.gzcp.df, aes(x=baseMean, y=log2FoldChange, col=sig)) +
  geom_point() +
  labs(x="Mean of Normalized Counts",
  ...
  geom_label(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-124-3p"), aes(baseMean, log2FoldChange, label=mirna), hjust=0, vjust=1.5, color=labelColor) +
  geom_label(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-124-5p"), aes(baseMean, log2FoldChange, label=mirna), hjust=0, vjust=1.5, color=labelColor) +
  geom_label(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-9-5p"), aes(baseMean, log2FoldChange, label=mirna), hjust=1, vjust=1.5, color=labelColor) +
  geom_label(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-9-3p"), aes(baseMean, log2FoldChange, label=mirna), hjust=0, vjust=1.5, color=labelColor) +
  geom_point(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-124-3p"), aes(baseMean, log2FoldChange), shape=21, size=4, stroke=2, color=circColor) +
  geom_point(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-124-5p"), aes(baseMean, log2FoldChange), shape=21, size=4, stroke=2, color=circColor) +
  geom_point(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-9-5p"), aes(baseMean, log2FoldChange), shape=21, size=4, stroke=2, color=circColor) +
  geom_point(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-9-3p"), aes(baseMean, log2FoldChange), shape=21, size=4, stroke=2, color=circColor) +
  geom_label(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-92b-3p"), aes(baseMean, log2FoldChange, label=mirna), hjust=1, vjust=1.5, color=labelColor) +
  geom_point(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-92b-3p"), aes(baseMean, log2FoldChange), shape=21, size=4, stroke=2, color=circColor) +
  geom_label(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-92b-5p"), aes(baseMean, log2FoldChange, label=mirna), hjust=1, vjust=1.5, color=labelColor) +
  geom_point(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-92b-5p"), aes(baseMean, log2FoldChange), shape=21, size=4, stroke=2, color=circColor)
  
#ggsave("~/Desktop/shrunken_l2fc_labels.pdf", plot=p1, width = 11, height = 6, useDingbats = FALSE)
...
ggplot(shrunkres.gzcp.df, aes(x=baseMean, y=log2FoldChange, col=sig)) +
  ...
  plotTheme +
  scale_color_manual(values=c("grey50", "red")) +
  geom_label(aes(x=0.01, y=2, label="up in GZ"), hjust=0, color=labelColor) +
  geom_label(aes(x=0.01, y=-2, label="up in CP"), hjust=0, color=labelColor) +
  #geom_label(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-125a-3p"), aes(baseMean, log2FoldChange, label=mirna), hjust=0, vjust=1.5, color=labelColor) +
  geom_label(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-125a-5p"), aes(baseMean, log2FoldChange, label=mirna), hjust=1, vjust=1.5, color=labelColor) +
  geom_label(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-99b-5p"), aes(baseMean, log2FoldChange, label=mirna), hjust=1, vjust=1.5, color=labelColor) +
  #geom_label(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-99b-3p"), aes(baseMean, log2FoldChange, label=mirna), hjust=0, vjust=1.5, color=labelColor) +
  #geom_label(data=subset(shrunkres.gzcp.df, mirna == "hsa-let-7e-3p"), aes(baseMean, log2FoldChange, label=mirna), hjust=1, vjust=1.5, color=labelColor) +
  geom_label(data=subset(shrunkres.gzcp.df, mirna == "hsa-let-7e-5p"), aes(baseMean, log2FoldChange, label=mirna), hjust=1.1, vjust=.5, color=labelColor) +
  #geom_point(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-125a-3p"), aes(baseMean, log2FoldChange), shape=21, size=4, stroke=2, color=circColor) +
  geom_point(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-125a-5p"), aes(baseMean, log2FoldChange), shape=21, size=4, stroke=2, color=circColor) +
  geom_point(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-99b-5p"), aes(baseMean, log2FoldChange), shape=21, size=4, stroke=2, color=circColor) +
  #geom_point(data=subset(shrunkres.gzcp.df, mirna == "hsa-miR-99b-3p"), aes(baseMean, log2FoldChange), shape=21, size=4, stroke=2, color=circColor) +
  #geom_point(data=subset(shrunkres.gzcp.df, mirna == "hsa-let-7e-3p"), aes(baseMean, log2FoldChange), shape=21, size=4, stroke=2, color=circColor) +
  geom_point(data=subset(shrunkres.gzcp.df, mirna == "hsa-let-7e-5p"), aes(baseMean, log2FoldChange), shape=21, size=4, stroke=2, color=circColor)

ggsave("~/Desktop/shrunken_l2fc_gzcp_let7e_99b_125a.pdf", width = 11, height = 6, useDingbats = FALSE)
