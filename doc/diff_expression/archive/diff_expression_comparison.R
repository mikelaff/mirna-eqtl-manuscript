...
dds_gw_rds <- here("doc/diff_expression/rdata/dds_gw.rds")
...
combined_shrunk_results_df %>%
  ...
  geom_point(data=subset(combined_shrunk_results_df, mirna == "hsa-miR-124-3p"), aes(log2FoldChange.gw, -log2FoldChange.gzcp), shape=21, size=4, stroke=2, color=circColor) +
  ...
  geom_point(data=subset(combined_shrunk_results_df, mirna == "hsa-miR-92b-3p"), aes(log2FoldChange.gw, -log2FoldChange.gzcp), shape=21, size=4, stroke=2, color=circColor) +
