...
dir.output <- here("doc/mirQTL_plots/pdfs/mirQTL_ld_snps_mir101_mod/")
...
dir.genotypes <- here("results/emmax/association_results/20200102_mirQTLor_mir101_mod/sample_genotypes/")
...
dir.ld <- here("results/emmax/association_results/20200102_mirQTLor_mir101_mod/ld/")
...
cov.mat.auto.file <- here("results/emmax/covariates/20200102_chrAutosomes.mirQTLor.mir101_mod.columnLabeled.cov")
# Covariate matrix x chromosome
cov.mat.x.file <- here("results/emmax/covariates/20200102_chrX.mirQTLor.mir101_mod.columnLabeled.cov")
...
batchVars.auto <- c(paste0("PC", 1:10, ".genotype"),
                    paste0("PC", c(1:2,4:10), ".expression"),
