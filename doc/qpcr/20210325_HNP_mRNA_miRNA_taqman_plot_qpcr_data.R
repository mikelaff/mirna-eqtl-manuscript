...
# INPUT ################################################################################################################
# mRNA qPCR data from 25 Mar 2021
mRNA.data.xlsx <- here("results/qpcr/20210325_HNP_mRNA.xlsx")

# miRNA qPCR TaqMan data from 25 Mar 2021
miRNA.taqman.data.xlsx <- here("results/qpcr/20210325_HNP_miRNA_TaqMan.xlsx")
...
ggsave("~/Desktop/ptrex_mrna.pdf", width = 10, height = 7)
