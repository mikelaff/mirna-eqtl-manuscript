...
d54.week1.nuclei.csv <- here("results/microscopy/2022_Diff_Experiment/D54_week1/output/D54_week1_Nuclei.csv")
d54.week1.Cy7cells.csv <- here("results/microscopy/2022_Diff_Experiment/D54_week1/output/D54_week1_Cy7_cells.csv")
d54.week1.TxRedcells.csv <- here("results/microscopy/2022_Diff_Experiment/D54_week1/output/D54_week1_TxRed_cells.csv")
d54.week1.GFPcells.csv <- here("results/microscopy/2022_Diff_Experiment/D54_week1/output/D54_week1_GFP_cells.csv")
d54.week1.images.csv <- here("results/microscopy/2022_Diff_Experiment/D54_week1/output/D54_week1_Image.csv")
...
d54.week2.nuclei.csv <- here("results/microscopy/2022_Diff_Experiment/D54_week2/output/D54_week2_Nuclei.csv")
d54.week2.Cy7cells.csv <- here("results/microscopy/2022_Diff_Experiment/D54_week2/output/D54_week2_Cy7_cells.csv")
d54.week2.TxRedcells.csv <- here("results/microscopy/2022_Diff_Experiment/D54_week2/output/D54_week2_TxRed_cells.csv")
d54.week2.GFPcells.csv <- here("results/microscopy/2022_Diff_Experiment/D54_week2/output/D54_week2_GFP_cells.csv")
d54.week2.images.csv <- here("results/microscopy/2022_Diff_Experiment/D54_week2/output/D54_week2_Image.csv")
