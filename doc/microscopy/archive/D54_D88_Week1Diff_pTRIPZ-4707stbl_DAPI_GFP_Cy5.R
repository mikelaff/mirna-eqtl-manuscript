...
nuclei.csv <- here("results/microscopy/D54_D88_Diff1week_pTRIPZ-4707stbl_GFAP_Tuj1/output/D54_D88_Diff1week_pTRIPZ-4707stbl_DAPI_GFP_Cy5_Nuclei.csv")
Cy5objects.csv <- here("results/microscopy/D54_D88_Diff1week_pTRIPZ-4707stbl_GFAP_Tuj1/output/D54_D88_Diff1week_pTRIPZ-4707stbl_DAPI_GFP_Cy5_Cy5objects.csv")
GFPobjects.csv <- here("results/microscopy/D54_D88_Diff1week_pTRIPZ-4707stbl_GFAP_Tuj1/output/")
images.csv <- here("results/microscopy/D54_D88_Diff1week_pTRIPZ-4707stbl_GFAP_Tuj1/output/D54_D88_Diff1week_pTRIPZ-4707stbl_DAPI_GFP_Cy5_Image.csv")
plate.layout.csv <- here("results/microscopy/D54_D88_Diff1week_pTRIPZ-4707stbl_GFAP_Tuj1/plate_layout.csv")
...
pdf("~/Desktop/week1diff_4707stable.pdf")

df.Cy5objects.summary %>%
    ggplot(mapping = aes(x = Donor, y = Cy5positive_over_nuclei, color = DOX)) +
    geom_boxplot() +
    facet_wrap(~Primary_AB) +
    labs(title = "Week 1 Diff. pTRIPZ-4707stable",
         caption = "48 wells, 432 images") +
