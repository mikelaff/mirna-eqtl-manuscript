...
fisher_test_overlap_rds <- here("doc/target_overlap/rdata/mirna_fisher_test_overlap_high_l2fc_results.rds")
...
genes_gz_greater_than_cp <- filter(arrange(gene_df, -log2FoldChange.gzcp), category == "neurogenesis_gz")$ensg[1:1000]
genes_cp_greater_than_gz <- filter(arrange(gene_df, log2FoldChange.gzcp), category == "neurogenesis_cp")$ensg[1:1000]

genes_maturation_early <- filter(arrange(gene_df, log2FoldChange.gw), category == "maturation_early")$ensg[1:1000]
genes_maturation_late <- filter(arrange(gene_df, -log2FoldChange.gw), category == "maturation_late")$ensg[1:1000]
