...
# data frame with fisher test results for miRDB 2019 predicted targets with novel miRNAs
df.known.novel.enrichments.mirdb.rds <- paste(paste(here("doc/target_overlap/rdata/"),
                                                    date.prefix, "_miRDB_known_novel_enrichments.rds", sep=""))
...
# Save Results ########################################################################################################
saveRDS(df.mirna.enrichments, df.known.novel.enrichments.mirdb.rds)

stop()
# Heatmaps ############################################################################################################

dfM <- readRDS(here("doc/target_overlap/rdata/20190530_miRDB_known_novel_enrichments.rds"))

source(here("doc/target_overlap/utils/target_overlap_heatmap.R"))


png(paste(dir.png, "heatmap_enrich_deplet_matur_mirs_mirdb_10counts_known_novel.png", sep="/"),
    height = 800,
    width = 800)
...
png(paste(dir.png, "heatmap_enrich_deplet_neuro_mirs_mirdb_10counts_known_novel.png", sep="/"),
    height = 800,
    width = 800)
...
# pdfs
pdf(paste(dir.pdf, "heatmap_enrich_deplet_matur_mirs_mirdb_10counts_known_novel.pdf", sep="/"),
    height = 10,
    width = 8,
    useDingbats = FALSE)
plot.enrichments(dfM, categories = c("MatEarly", "MatLate"),
...
pdf(paste(dir.pdf, "heatmap_enrich_deplet_neuro_mirs_mirdb_10counts_known_novel.pdf", sep="/"),
    height = 10,
    width = 8,
    useDingbats = FALSE)
plot.enrichments(dfM, categories = c("NeuroGZ", "NeuroCP"),
