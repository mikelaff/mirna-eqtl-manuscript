...
# OUTPUT FILES ########################################################################################################
sources2.csv <- here("doc/target_overlap/20190514_miRNA_predictions_2sources.csv")
sources3.csv <- here("doc/target_overlap/20190514_miRNA_predictions_3sources.csv")
sources4.csv <- here("doc/target_overlap/20190514_miRNA_predictions_4sources.csv")
...
saveRDS(df.predictions, here("doc/target_overlap/rdata/20190514_miRNA_predictions_2sources.rds"))
write_csv(df.predictions, here("doc/target_overlap/20190514_miRNA_predictions_2sources.csv"))
