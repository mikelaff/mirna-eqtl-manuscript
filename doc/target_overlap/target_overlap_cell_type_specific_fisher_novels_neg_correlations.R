...
df.known.novel.enrichments.mirdb.rds <- paste(paste(here("doc/target_overlap/rdata/"),
                                                    date.prefix, "_miRDB_known_novel_enrichments_neg_corr.rds", sep=""))
# data frame with fisher test results 2,3,4 sources miRNAtap, neg. correlated with target expression
df.enrichments.2sources.rds <- paste(paste(here("doc/target_overlap/rdata/"), date.prefix, "_miRNAtap_enrichments_2sources_neg_corr.rds", sep=""))
df.enrichments.3sources.rds <- paste(paste(here("doc/target_overlap/rdata/"), date.prefix, "_miRNAtap_enrichments_3sources_neg_corr.rds", sep=""))
df.enrichments.4sources.rds <- paste(paste(here("doc/target_overlap/rdata/"), date.prefix, "_miRNAtap_enrichments_4sources_neg_corr.rds", sep=""))
