...
# working directory: /pine/scr/m/i/mikelaff/mirge/combo_predict/
...
comboFile="/pine/scr/m/i/mikelaff/mirge/combo_predict/fastq/combined_reads.fastq.gz"
...
ssub --notify=ON --mem=256g -n 8 -N 1 --wrap=\"miRge2.0 predict\
					-s ${comboFile}\
					-d miRBase\
					-pb ${bowtieBin}\
					-lib ${mirgeLibs}\
