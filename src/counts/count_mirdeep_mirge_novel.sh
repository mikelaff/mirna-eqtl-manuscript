...
gtfFile="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/data/gtf_and_granges/20190430_mirdeep_mirge_novel_mirna.gtf"

dataroot="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/results/small_rna_seq_bams/"
outputroot="/pine/scr/m/i/mikelaff/counts/mirdeep_mirge/"

sampleList="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/src/counts/RNAIDnumbers.txt"

outputSuffix=".mirdeep.mirge.novel.miRNA.counts"
