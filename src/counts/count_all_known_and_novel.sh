...
gtfFile="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/data/gtf_and_granges/20190430_all_known_and_novel_mirna.gtf"

dataroot="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/results/small_rna_seq_bams/"
outputroot="/pine/scr/m/i/mikelaff/counts/all_known_and_novel/"

sampleList="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/src/counts/RNAIDnumbers.txt"

outputSuffix=".all.known.and.novel.miRNA.counts"
