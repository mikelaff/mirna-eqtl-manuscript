...
output.dir <- paste0(here("results/emmax/phenotype_files/"), date.prefix, "_mirQTLor_VST_miRNA_expression_residual/")
...
for (chr in CHROMS) {
    ...
    mirs <- NULL
    mirs <- df.mirs$uniqueName[which(df.mirs$seqnames == chr)]
