...
chrAutosomes.cov.mat.output <- paste0(dir.cov.matrix, date.prefix, "_chrAutosomes.mirQTLor.genotypePCA_10.expressionPCA_10.pool.purMethod.rin.sex.gestWeek.cov")
chrAutosomes.cov.mat.labeled.output <- paste0(dir.cov.matrix, date.prefix, "_chrAutosomes.mirQTLor.columnLabeled.cov")
