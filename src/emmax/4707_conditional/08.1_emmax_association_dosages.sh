...
phenoDirRoot="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/results/emmax/phenotype_files/20201012_mirQTLor_VST_miRNA_expression_residual_4707_edu_attain/"

# Output directory
outputDir="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/results/emmax/association_results/20201012_mirQTLor_4707_cond/"
...
do
	...
	do
		...
		outputPrefix="chr${chr}.dosage.prefiltered.mirQTLor.${uniName}"
