...
# OUTPUT FILES ########################################################################################################
# eQTL output files
eqtl.df.rds <- paste0(here("results/eigenmt/"), results.name, "/compiled/", results.name, "_eQTLs_dataFrame.rds")
eqtl.gr.rds <- paste0(here("results/eigenmt/"), results.name, "/compiled/", results.name, "_eQTLs_GRanges.rds")

# emiR output files
emir.df.rds <- paste0(here("results/eigenmt/"), results.name, "/compiled/", results.name, "_emiRs_dataFrame.rds")
emir.gr.rds <- paste0(here("results/eigenmt/"), results.name, "/compiled/", results.name, "_emiRs_GRanges.rds")

# eSNP output files
esnp.df.rds <- paste0(here("results/eigenmt/"), results.name, "/compiled/", results.name, "_eSNPs_dataFrame.rds")
esnp.gr.rds <- paste0(here("results/eigenmt/"), results.name, "/compiled/", results.name, "_eSNPs_GRanges.rds")

# INPUT FILES ##########################################################################################################
# Clumped results directory
results.dir <- paste0(here("results/eigenmt/"), results.name, "/clumped/")
