...
output.dir <- here("results/conditional_eqtls/20200120_mirQTLor_fdr5percent_noEigenMT/tertiary/association_results/compiled/")
dir.create(output.dir, recursive = TRUE, showWarnings = FALSE)

# output GRangesList RDS file
output.grl.rds <- paste0(output.dir, results.name, "_tertiary_variants_GRangesList.rds")

# output data frame RDS file
output.df.rds <- paste0(output.dir, results.name, "_tertiary_variants_dataFrame.rds")

# INPUT FILES #########################################################################################################
# emmax result files directory, column labeled
results.dir <- here("results/conditional_eqtls/20200120_mirQTLor_fdr5percent_noEigenMT/tertiary/association_results/ps/")

# mirs in this analysis
genes.tsv <- here("results/conditional_eqtls/20200120_mirQTLor_fdr5percent_noEigenMT/secondary/20200120_mirQTLor_fdr5percent_noEigenMT_VST_miRNA_expression_residual_after_secondary_eqtl/20200120_mirQTLor_fdr5percent_noEigenMT_genes_hg38.txt")
...
for (i in 1:nrow(genes)) {
    ...
    ps.file <- paste0(results.dir, chr, ".dosage.prefiltered.mirQTLor.tertiary.", uniName, ".ps")
