...
# OUTPUT FILES ########################################################################################################
# output directory
output.dir <- paste0(here("results/conditional_eqtls/"), results.name, "/quarternary/")
dir.create(output.dir, recursive = TRUE, showWarnings = FALSE)

# eQTL output file
eqtl.df.rds <- paste0(output.dir, results.name, "_quarternary_eQTLs_dataFrame.rds")

# primary eSNPs to get genotypes using plink
esnps.txt <- paste0(output.dir, results.name, "_quarternary_eSNPs.txt")
...
summarized.results.dataframe.rds <- here("results/conditional_eqtls/20200120_mirQTLor_fdr5percent_noEigenMT/quarternary/association_results/compiled/20200120_mirQTLor_fdr5percent_noEigenMT_quarternary_variants_dataFrame.rds")
