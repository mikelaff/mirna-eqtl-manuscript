...
phenoDirRoot="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/results/conditional_eqtls/20200120_mirQTLor_fdr5percent_noEigenMT/quarternary/20200120_mirQTLor_fdr5percent_noEigenMT_VST_miRNA_expression_residual_after_quarternary_eqtl/"

# Output directory
outputDir="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/results/conditional_eqtls/20200120_mirQTLor_fdr5percent_noEigenMT/quinary/association_results/"
...
do
	...
	do
		...
		outputPrefix="chr${chr}.dosage.prefiltered.mirQTLor.quinary.${uniName}"
