...
# results directory
resultsDir="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/results/conditional_eqtls/${resultsName}/quarternary/"
...
esnpsFile="${resultsDir}/${resultsName}_quarternary_eSNPs.txt"

# output directory for sample genotypes
outputDir="${resultsDir}/quarternary_eSNP_genotypes/"
