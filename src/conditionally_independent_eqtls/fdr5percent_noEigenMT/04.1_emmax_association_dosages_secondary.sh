...
phenoDirRoot="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/results/conditional_eqtls/20200120_mirQTLor_fdr5percent_noEigenMT/primary/20200120_mirQTLor_fdr5percent_noEigenMT_VST_miRNA_expression_residual_after_primary_eqtl/"

# Output directory
outputDir="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/results/conditional_eqtls/20200120_mirQTLor_fdr5percent_noEigenMT/secondary/association_results/"
...
do
	...
	do
		...
		outputPrefix="chr${chr}.dosage.prefiltered.mirQTLor.secondary.${uniName}"
