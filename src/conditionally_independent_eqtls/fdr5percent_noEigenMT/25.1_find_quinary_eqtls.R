...
# OUTPUT FILES ########################################################################################################
# output directory
output.dir <- paste0(here("results/conditional_eqtls/"), results.name, "/quinary/")
dir.create(output.dir, recursive = TRUE, showWarnings = FALSE)

# eQTL output file
eqtl.df.rds <- paste0(output.dir, results.name, "_quinary_eQTLs_dataFrame.rds")

# primary eSNPs to get genotypes using plink
esnps.txt <- paste0(output.dir, results.name, "_quinary_eSNPs.txt")
...
summarized.results.dataframe.rds <- here("results/conditional_eqtls/20200120_mirQTLor_fdr5percent_noEigenMT/quinary/association_results/compiled/20200120_mirQTLor_fdr5percent_noEigenMT_quinary_variants_dataFrame.rds")
