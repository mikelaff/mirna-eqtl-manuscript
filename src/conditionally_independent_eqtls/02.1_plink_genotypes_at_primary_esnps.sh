...
# results directory
resultsDir="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/results/conditional_eqtls/${resultsName}/primary/"
...
esnpsFile="${resultsDir}/${resultsName}_primary_eSNPs.txt"

# output directory for sample genotypes
outputDir="${resultsDir}/primary_eSNP_genotypes/"
