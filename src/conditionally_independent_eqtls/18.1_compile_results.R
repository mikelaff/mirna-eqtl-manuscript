...
output.dir <- here("results/conditional_eqtls/20200120_mirQTLor/quarternary/association_results/compiled/")
...
results.dir <- here("results/conditional_eqtls/20200120_mirQTLor/quarternary/association_results/ps/")

# mirs in this analysis
genes.tsv <- here("results/conditional_eqtls/20200120_mirQTLor/tertiary/20200120_mirQTLor_VST_miRNA_expression_residual_after_tertiary_eqtl/20200120_mirQTLor_genes_hg38.txt")
