...
# results directory
resultsDir="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/results/conditional_eqtls/${resultsName}/tertiary/"

# samples file
keepFile="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/results/emmax/samples/${resultsName}_DonorID_DNAID.txt"

# list of primary eSNPs
esnpsFile="${resultsDir}/${resultsName}_tertiary_eSNPs.txt"

# output directory for sample genotypes
outputDir="${resultsDir}/tertiary_eSNP_genotypes/"
