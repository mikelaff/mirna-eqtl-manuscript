...
primary.results.rds <- here("results/emmax/association_results/20200120_mirQTLor_fdr10percent/compiled/20200120_mirQTLor_fdr10percent_variants_dataFrame.rds")
# secondary association results
secondary.results.rds <- here("results/conditional_eqtls/20200120_mirQTLor_fdr10percent/secondary/association_results/compiled/20200120_mirQTLor_fdr10percent_secondary_variants_dataFrame.rds")
# tertiary association results
tertiary.results.rds <- here("results/conditional_eqtls/20200120_mirQTLor_fdr10percent/tertiary/association_results/compiled/20200120_mirQTLor_fdr10percent_tertiary_variants_dataFrame.rds")
# quarternary association results
quarternary.results.rds <- here("results/conditional_eqtls/20200120_mirQTLor_fdr10percent/quarternary/association_results/compiled/20200120_mirQTLor_fdr10percent_quarternary_variants_dataFrame.rds")
...
nom.p.value.txt <- here("results/eigenmt/20200120_mirQTLor/compiled/20200120_mirQTLor_eigenMT-BH_nomPvalue_10percent.txt")
