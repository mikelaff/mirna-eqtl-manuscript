...
output.dir <- here("results/conditional_eqtls/20200120_mirQTLor/secondary/association_results/compiled/")
...
results.dir <- here("results/conditional_eqtls/20200120_mirQTLor/secondary/association_results/ps/")

# mirs in this analysis
genes.tsv <- here("results/conditional_eqtls/20200120_mirQTLor/primary/20200120_mirQTLor_VST_miRNA_expression_residual_after_primary_eqtl/20200120_mirQTLor_genes_hg38.txt")
