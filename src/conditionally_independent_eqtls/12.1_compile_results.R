...
output.dir <- here("results/conditional_eqtls/20200120_mirQTLor/tertiary/association_results/compiled/")
...
results.dir <- here("results/conditional_eqtls/20200120_mirQTLor/tertiary/association_results/ps/")

# mirs in this analysis
genes.tsv <- here("results/conditional_eqtls/20200120_mirQTLor/secondary/20200120_mirQTLor_VST_miRNA_expression_residual_after_secondary_eqtl/20200120_mirQTLor_genes_hg38.txt")
