...
dataDir="/proj/steinlab/raw/FetalTissueQTL/Genotypes/RawData/2013-438/FinalReports.IlluminaXrecluster_140424/"
...
do
	...
	awk 'BEGIN {FS=" ";} {if (NR > 11) {if ($8 == "-") {print $2$3,$2$3,$5,0,0} else {print $2$3,$2$3,$5,$8,$9}}}' ${tmpFile} >> ${lgenFile}
...
awk 'BEGIN {FS=" ";} {if (NR > 11) print $6,$5,0,$7}' ${tmpFile} > ${mapFile}
rm ${tmpFile}
