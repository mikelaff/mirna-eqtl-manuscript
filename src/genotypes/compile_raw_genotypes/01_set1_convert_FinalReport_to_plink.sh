...
dataDir="/proj/steinlab/raw/FetalTissueQTL/Genotypes/RawData/2012-092/FinalReports/"

# Output Directory
outputDir="/proj/steinlab/projects/miRNA-eQTL-project/mirna-eqtl/results/genotypes/compiled_raw_genotypes/set1/"
mkdir -p ${outputDir}
...
for file in `ls ${dataDir}2012-092.*.bz2`
do
	echo ${file}
...
bzip2 -cd `ls ${dataDir}2012-092.*.bz2 | awk '{if (NR==1) print $1}'` > ${tmpFile}
