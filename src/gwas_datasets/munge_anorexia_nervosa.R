# format Anorexia Nervosa GWAS data
...
# OUTPUT FILES #########################################################################################################
output.granges.rds <- here("data/gwas_datasets/anorexia_nervosa/anorexia_nervosa.hg38.GRanges.rds")

# INPUT FILES ##########################################################################################################

raw.data <- here("data/gwas_datasets/anorexia_nervosa/download/pgcAN2.2019-07.vcf.tsv.gz")
...
df.raw <- read_tsv(raw.data, skip = 70)
