# format Antisocial Behavior GWAS data
...
# OUTPUT FILES #########################################################################################################
output.granges.rds <- here("data/gwas_datasets/antisocial_behavior/antisocial_behavior.hg38.GRanges.rds")

# INPUT FILES ##########################################################################################################

raw.data <- here("data/gwas_datasets/antisocial_behavior/download/BroadABC_METALoutput_CombinedwrsID.tbl.gz")
...
df.raw <- read_tsv(raw.data, col_types = cols(MarkerName2 = col_character()))
