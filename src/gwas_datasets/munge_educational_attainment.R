...
# OUTPUT FILES #########################################################################################################
output.granges.rds <- here("data/gwas_datasets/educational_attainment/educational_attainment.hg38.GRanges.rds")

# INPUT FILES ##########################################################################################################

raw.data <- here("data/gwas_datasets/educational_attainment/download/GWAS_EA_excl23andMe.txt.gz")
...
# Import Data ##########################################################################################################
print("Importing Educational Attainment data...")

df.raw <- read_tsv(raw.data)
...
# modify to UCSC naming, this dataset does not have X or Y variants
df.raw %<>%
