...
# OUTPUT FILES #########################################################################################################
output.granges.rds <- here("data/gwas_datasets/iq/iq.hg38.GRanges.rds")

# INPUT FILES ##########################################################################################################

raw.data <- here("data/gwas_datasets/iq/download/SavageJansen_2018_intelligence_metaanalysis.txt.gz")
...
df.raw <- read_tsv(raw.data, col_types = cols(UNIQUE_ID = col_character()))
