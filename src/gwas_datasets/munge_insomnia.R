...
# OUTPUT FILES #########################################################################################################
output.granges.rds <- here("data/gwas_datasets/insomnia/insomnia.hg38.GRanges.rds")

# INPUT FILES ##########################################################################################################

raw.data <- here("data/gwas_datasets/insomnia/download/Insomnia_sumstats_Jansenetal.txt.gz")
...
df.raw <- read_tsv(raw.data, col_types = cols(CHR = col_character()))
