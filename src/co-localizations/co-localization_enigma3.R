...
# INPUT FILES ##########################################################################################################
# GWAS data
dir.gr.global.rds <- here("data/gwas_datasets/enigma3/ENIGMA3_Global/")
dir.gr.regional.rds <- here("data/gwas_datasets/enigma3/ENIGMA3_withGlobal/")
...
# Get LD Buddies #######################################################################################################
# loop over each mirQTL and get high LD buddies
